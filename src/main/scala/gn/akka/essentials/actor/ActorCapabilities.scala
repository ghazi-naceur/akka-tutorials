  ...
  def main(args: Array[String]): Unit = {
    class SimpleActor extends Actor {
      ...
      override def receive: Receive = {
        ...
        case SendMessageToYourself(content) => println(s"Receiving content '$content'")
        ...
        case WirelessPhoneMessage(content, reference) => reference forward content // Keeping the original sender of the WPM
      }
    }
